...
if __name__ == '__main__':
    ...
    try:
        # t1 = threading.Thread(target=crawl_1, args=(topicID,)) #讨论
        t2 = threading.Thread(target=crawl_2, args=(topicID,)) #精华
        # t3 = threading.Thread(target=crawl_3, args=(topicID,)) #等待回答
        # t1.start()
        t2.start()
        # t3.start()
    except:
